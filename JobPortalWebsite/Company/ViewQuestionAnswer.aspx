...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" Runat="Server">
    ...
    <div class="row">
        <div class="col-xs-12">
            <span class="h3">View Question Answer</span>
        <span class="pull-right"><asp:LinkButton runat="server" ID="LnkBtnAddQuestion" Font-Size="Large" Text="Ask a Question" CssClass="btn btn-info" OnClick="LnkBtnAddQuestion_Click"></asp:LinkButton></span>
        </div>
    </div>
    <br />
    <div class="row">
