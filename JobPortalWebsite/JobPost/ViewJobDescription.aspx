...
<asp:Content ID="Content1" ContentPlaceHolderID="Body" Runat="Server">
    ...
    <div class="table-responsive">
        <asp:GridView runat="server" HeaderStyle-BackColor="#344154" Font-Size="Large" AlternatingRowStyle-BackColor="#cccccc" HeaderStyle-ForeColor="White" BorderColor="#ff00ff" ID="GridViewBranches" AutoGenerateColumns="false" OnRowDataBound="GridViewBranches_RowDataBound" CssClass="table table-bordered table-hover table-responsive">
            <Columns>
