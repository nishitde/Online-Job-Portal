<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ViewCompany.master" AutoEventWireup="true" CodeFile="ViewCompany.aspx.cs" Inherits="Company_ViewCompany" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" Runat="Server">
    ...
    <div class="row">
            ...
            <span class="h4">Company Name:&nbsp;&nbsp;<asp:Label runat="server" ID="LblCompanyName" Visible="true" Text="Demo"></asp:Label>&nbsp;&nbsp;&nbsp;<asp:LinkButton runat="server" ID="LnkBtnEditCompanyDetails" OnClick="LnkBtnEditCompanyDetails_Click" CssClass="glyphicon-pencil glyphicon h4"></asp:LinkButton></span>
            <br />
            <br />
            <span class="h4">Website:&nbsp;&nbsp;<asp:Label runat="server" ID="LblWebsiteURL" Visible="true"></asp:Label></span>
            <br />
            <br />
            <span class="h4">Industry:&nbsp;&nbsp;<asp:Label runat="server" ID="LblIndustry" Visible="true"></asp:Label></span>
    </div>
    <br />
    <div class="row">
        <span class="h4">Description :</span>
        <br />
        <asp:Label runat="server" ID="LblDescription" CssClass="h4" Visible="true" ViewStateMode="Enabled" TextMode="MultiLine" ></asp:Label>
    </div>
    <br />
  ...
  <div class="modal-dialog">
    ...
    <br />
      ...
      <div class="modal-footer">
          <div class="row">
              <asp:Button runat="server" ID="BtnUpdateCompany" Text="Update this Company" ValidationGroup="EditCompany" CausesValidation="true" CssClass="btn btn-default" OnClick="BtnUpdateCompany_Click"/>
            &nbsp;&nbsp;
