...
namespace MyJobPortalModel {
    ...
    public class City {
        ...
        public City(int ID) {
			...
			ObjConnection.Open();
			SqlCommand ObjCommand = new SqlCommand("select * from City where ID = " + ID , ObjConnection);
			SqlDataReader ObjReader = ObjCommand.ExecuteReader();
			ObjReader.Read();
			if(ObjReader["Id"] != DBNull.Value)
				Id = (int)ObjReader["Id"];
			if(ObjReader["CityName"] != DBNull.Value)
				CityName = (string)ObjReader["CityName"];
        ...
        public static Int32 AddCity(String CityName, Int32 StateId, Int32 CountryId, String Status) {
			string strsql = "insert into City output inserted.id values(" + "'"+ CityName.Replace("'","''") + "'," + StateId + "," + CountryId + "," + "'"+ Status.Replace("'","''") + "'" + ")"; 
			SqlConnection ObjConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["MyJobPortal"].ConnectionString);
			ObjConnection.Open();
        ...
        public static DataTable GetCityRecords(string WhereClause) {
			SqlConnection ObjConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["MyJobPortal"].ConnectionString);
        ...
        public void Update() {
			string strsql= "update City set " + "CityName= '" + CityName.Replace("'","''") + "', " + "StateId= " + StateId + ", " + "CountryId= " + CountryId + ", " + "Status= '" + Status.Replace("'","''") + "' " + " where ID ="  + Id ;
			SqlConnection ObjConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["MyJobPortal"].ConnectionString);
			ObjConnection.Open();
			SqlCommand ObjCommand = new SqlCommand(strsql,ObjConnection);
        ...
        public static void DeleteCityRecords(string WhereClause) {
			SqlConnection ObjConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["MyJobPortal"].ConnectionString);
			ObjConnection.Open();
			DataTable ObjDataTable= new DataTable();
			string strsql ="delete from City";
			if(WhereClause != String.Empty) strsql= strsql + " where " + WhereClause;
			SqlCommand ObjCommand = new SqlCommand(strsql,ObjConnection);
			ObjCommand.ExecuteNonQuery();
			ObjCommand.Dispose();
